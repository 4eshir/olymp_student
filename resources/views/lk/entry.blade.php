        ...
        @if ($model->completed())
            <div class="verification_success">
                <p class="verification_text">
                    <b>Шаг 5. Заполните регистрационную форму, чтобы подать заявку на школьный предмет. Убедитесь что заявка сохранена в системе и отображается в блоке "Мои олимпиады"</b>
                </p>
                <p>К участию в региональном этапе олимпиады по каждому общеобразовательному предмету допускаются:
                    <br>- участники муниципального этапа олимпиады текущего учебного года, набравшие необходимое для участия в региональном этапе олимпиады количество баллов, установленное организатором регионального этапа олимпиады;
                    <br>- победители и призеры регионального этапа олимпиады предыдущего учебного года, продолжающие освоение основных образовательных программ основного общего и среднего общего образования;</p>
            </div>
